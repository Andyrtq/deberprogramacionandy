...
public class Verificacion {
    /**
     * Programa para verificar a traves ade metodos si un número es primo o no y si es par o impar
     */
    public static class Verificacion2 {
        ...
        public static void main(String[] args) {
            Verificacion2 mivariable = new Verificacion2();
            mivariable.ejecutar();
